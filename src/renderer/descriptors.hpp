...
namespace tml {
    ...
    class TmlDescriptorSetLayout {
        public:
            ...
            TmlDescriptorSetLayout(TmlDevice &tmlDevice, std::unordered_map<uint32_t, VkDescriptorSetLayoutBinding> bindings);
    ...
    class TmlDescriptorPool {
        public:
            ...
            TmlDescriptorPool(TmlDevice &tmlDevice, uint32_t maxSets, VkDescriptorPoolCreateFlags poolFlags, const std::vector<VkDescriptorPoolSize> &poolSizes);
            ~TmlDescriptorPool();
