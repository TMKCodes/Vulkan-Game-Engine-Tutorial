...
namespace tml {
    ...
    PointLightSystem::PointLightSystem(TmlDevice& device, VkRenderPass renderPass, VkDescriptorSetLayout globalSetLayout) : tmlDevice{device} {
    ...
    void PointLightSystem::createPipeline(VkRenderPass renderPass) {
        ...
        tmlPipeline = std::make_unique<TmlPipeline>(tmlDevice, "shaders/point_light.vert.spv", "shaders/point_light.frag.spv", pipelineConfig);
    }
    ...
    void PointLightSystem::render(FrameInfo& frameInfo) {
        // sort lights
        std::map<float, TmlDrawable::id_t> sorted;
        for (auto& kv : frameInfo.gameObjects) {
            auto& obj = kv.second;
            if (obj.pointLight == nullptr) continue;
            // calculate distance
